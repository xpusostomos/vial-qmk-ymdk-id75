...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_ortho_5x15(
    ...
    TG(1), KC_MPRV, KC_MPLY, KC_MSTP, KC_MNXT, KC_NO, KC_NO, RGB_TOG, RGB_MOD, RGB_VAI, RGB_SPI, RGB_SAI, RGB_HUI, KC_BRIU, KC_VOLU,
    KC_CAPS, KC_NO, KC_CUT, KC_COPY, KC_PSTE, KC_NO, KC_NO, RGB_TOG, RGB_RMOD, RGB_VAD, RGB_SPD, RGB_SAD, RGB_HUD, KC_BRID, KC_VOLD,
